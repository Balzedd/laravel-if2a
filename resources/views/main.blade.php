                ...
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item dropdown user-menu">
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">
                            <img src="{{ url('assets/img/mbg.jpg') }}" class="user-image rounded-circle shadow"
                                alt="User Image" />
                        ...
                        <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-end">
                            ...
                            <li class="user-header text-bg-primary">
                                <img src="{{ url('assets/img/mbg.jpg') }}" class="rounded-circle shadow"
                                    alt="User Image" />
                                <p>
                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <div class="card">
                                ...
                                <!-- /.card-body -->
                                <div class="card-footer"> <b>Balzed </b>Jago Koding 2029</div>
                                <!-- /.card-footer-->
                            </div>
                            <!-- /.card -->
                        </div>
